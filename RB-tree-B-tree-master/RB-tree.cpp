...
public:
    RBtree()
    {
        ...
        NIL->color=BLACK;
        root=NIL;
        freopen("D:\\DSA-II\\RB-tree-B-tree-master\\init.txt", "r", stdin);
        string str;
        getline(cin,str);
        PAIR pair_1;
        while (cin >> pair_1)
    ...
    void delete_by_file(string filepath="D:\\DSA-II\\RB-tree-B-tree-master\\delete.txt"){
        string str;
        PAIR pair;
    ...
    void insert_byfile(string filepath="D:\\DSA-II\\RB-tree-B-tree-master\\insert.txt"){
        string str;
        PAIR pair;
        freopen(filepath.c_str(),"r",stdin);
        getline(cin,str);
