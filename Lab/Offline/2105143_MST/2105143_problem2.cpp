...
public:
    ...
    void printEdgesByFlag()
    {
        //cout << "Edges with Flag -2:" << endl;
        for (const auto &edge : edgelist)
        {
            if (edge.flag == 2)
            {
                cout << "(" << edge.u + 1 << ", " << edge.v + 1 << ", " << edge.w << ") -> any" << endl;
            }
        }

        //cout << "Edges with Flag -1:" << endl;
        for (const auto &edge : edgelist)
        {
            if (edge.flag == -1)
            {
                cout << "(" << edge.u + 1 << ", " << edge.v + 1 << ", " << edge.w << ") -> none" << endl;
            }
        }
        ...
        for (const auto &edge : edgelist)
        {
            if (edge.flag == 1)
            {
                cout << "(" << edge.u + 1 << ", " << edge.v + 1<< ", " << edge.w << ") -> at least one" << endl;
            }
        }
    }
};
